            ...
            try:
                ...
                if geometry and geometry.get('type') in ('Polygon', 'MultiPolygon'):
                    ...
                    if region == "IDF":
                        ...
                        reference_year = int(properties.get('annee')) if properties.get('annee') else None
                        ...
                        reference_year = int(properties.get('annee', properties.get('year', datetime.now().year)))

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(blank=True, choices=[('TB', 'Très bon'), ('B', 'Bon'), ('P', 'Passable'), ('M', 'Mauvais'), ('', 'Non renseigné')], help_text="État de l'équipement", max_length=20)),
                ('comment', models.TextField(blank=True, help_text="Commentaire sur l'équipement")),
                ('quantity', models.IntegerField(blank=True, help_text="Quantité de l'équipement (pour les équipements comptables)", null=True)),

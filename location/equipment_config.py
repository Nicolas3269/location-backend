...
EQUIPEMENTS_SPECIFIQUES = {
    "kitchen": {
        "equipments": [
            ...
            {"id": "balais", "label": "Balais", "icon": "🧹", "furnished_only": True},
            {
                "id": "balayettes",
                "label": "Balayettes",
                "icon": "🧹",
            ...
            {"id": "pelles", "label": "Pelles", "icon": "🗑️", "furnished_only": True},
            {"id": "seaux", "label": "Seaux", "icon": "🪣", "furnished_only": True},
            {
                "id": "torchons",
                "label": "Torchons",
                "icon": "🧽",
            ...
            {"id": "nappes", "label": "Nappes", "icon": "🍽️", "furnished_only": True},
            ...
            {"id": "verres", "label": "Verres", "icon": "🥃", "furnished_only": True},
            {
                "id": "bols_tasses",
                "label": "Bols / Tasses",
                "icon": "☕",
            ...
            {"id": "carafes", "label": "Carafes", "icon": "🍶", "furnished_only": True},
            {
            ...
            {"id": "poeles", "label": "Poêles", "icon": "🍳", "furnished_only": True},
            {
                "id": "casseroles",
                "label": "Casseroles",
                "icon": "🍲",
    ...
    "bathroom": {
        "equipments": [
            ...
            {"id": "gants", "label": "Gants", "icon": "🧤", "furnished_only": True},
        ],
    },
    "wc": {
        "equipments": [
    ...
    "bedroom": {
        "equipments": [
            ...
            # Literie
            {"id": "lit", "label": "Lit", "icon": "🛜️", "furnished_only": True},
            {"id": "matelas", "label": "Matelas", "icon": "🛜️", "furnished_only": True},
            {"id": "taies", "label": "Taies", "icon": "🛜️", "furnished_only": True},
            {
                "id": "oreillers",
                "label": "Oreillers",
                "icon": "🛜️",
            ...
            {"id": "draps", "label": "Draps", "icon": "🛜️", "furnished_only": True},
            {
            ...
            {"id": "alaise", "label": "Alaise", "icon": "🛜️", "furnished_only": True},
        ],
    },
    "living": {
        "equipments": [
